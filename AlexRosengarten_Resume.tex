...
% Again, the address lines must be centered over entire width of resume:
 \moveleft.5\hoffset\centerline{PO Box 231048, Encinitas CA 92024  | (760)-518-7440   |  alexrosengarten@gmail.com | github.com/alxrsngrtn}

  \section{EDUCATION} University of California, San Diego, {\it La Jolla, CA} \hfill   June 2016 \\
		  {\sl B.S.} Computer Science \& {\sl B.S.} Cognitive Science
...
Frontend & Angular.js, HTM5/CSS3, Ionic/Cordova, Android  \\
Backend & SQL, Cassandra, REST, Flask, Node.js, Django, AWS (RDS, Lambda, EC2)\\
Data & Keras/Theano/Tenserflow, Scikit-Learn, Pandas, Apache Spark \\
Environment & Docker, Vagrant, POSIX/Windows, Git, SVM, Perforce
\end{tabular}
