...
% Again, the address lines must be centered over entire width of resume:
 \moveleft.5\hoffset\centerline{alex@aira.io | 5328 Middleton Road, San Diego, CA, 92109 | github.com/alxrsngrtn}
...
Client & Android, RxJava, Angular.js, HTML5/CSS3, Webpack \\
Backend & SQL, Cassandra, MQTT, REST, Flask, Django, Express.js, AWS, Google Cloud \\
Data & Keras/Tenserflow, Scikit-Learn, Numpy, Pandas, Jupyter, OpenCV, Theano, Apache Spark  \\
...
{\sl Machine Learning/Fullstack Engineer } \hfill            December 2017 - Present \\
		...
		\item Building core dialog engine. Includes a STT/TTS system, intent matching, and conversation state management. 
                \item Built voice telemetry system, captures speech utterances from users and the device. Speech simulation added for automated testing (AWS IoT, MQTT, DynamoDB).
                \item Implemented fisheye correction in the camera driver layer (Android Native, OpenCV, C++). 
...
{\sl Research Assistant } \hfill            January 2018 - Present \\
		...
		{\sl Software Engineer} \hfill            August 2016 - November 2017 \\
                Intuit, San Diego, CA
                 \begin{itemize}  \itemsep -2pt %reduce space between items
                 \item Developed C\# and C++ features for ProSeries, Windows professional tax software. 
...
%
		...
		{\sl Research Assistant} \hfill            June 2013 - September 2015 \\
                Natural Computation Laboratory, UCSD Dept. of Cognitive Science, La Jolla, CA
                 \begin{itemize}  \itemsep -2pt %reduce space between items
                 \item Created in-ear EEG device to detect seizures for people with epilepsy (SVMs, OpenBCI).
                 \item Build custom CNN layer for learned-norm pooling in EEG neural network application (Theano).
                 \item Created hands-on workshops to teach brain computer interface technology (OpenBCI, Python).
                 \item Developed BrainTag: a laser tag based neurofeedback game for children with Autism (Arduino, C). 
...
\section{PROJECTS}
                 {\sl Comp Mu} \hfill 	 October 2017 - Present 
                 \begin{itemize}  \itemsep -2pt % reduce space between items
