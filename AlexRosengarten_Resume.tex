...
\textbf{Languages} & Python, Java, C++, JavaScript, C\#, Scala/F\#/OCaml \\
\textbf{Technologies} & Android, Reactive Extensions, Spring Boot, Vue.js, SQL/No-SQL, AMQP, REST, AWS, Google Cloud \\
\textbf{Data Science} & Keras/Tenserflow, Scikit-Learn, OpenCV, PyData Stack, Apache Spark \\
...
{\bf Machine Learning/Software Engineer } \hfill Nov 2017 - Present \\
  Aira -- La Jolla/San Jose, CA
  \begin{itemize}  \itemsep -2pt %reduce space between items
    \item Developing {\bf Chloe}, a mobile-AI for new product line (Android, RxJava). 
    \item Built {\bf core dialog engine}. Includes a STT/TTS system and conversation state management. Built features such as bluetooth pairing, calling an agent, and call rating purely throuch a voice interface. 
    ...
    \item Project lead for {\bf Horus}, a Python CLI for ML video analytics (STT \& object detection).
    \item Creating {\bf image tagging game} to generate dataset integral to company IP (Spring Boot, Vue.js).
    \item Created {\bf wake word detector}. Built a CNN model and audio processing pipeline (Tensorflow).
    \item Making important design \& architecture decisions on AI products (e.g. inter-day call forcasting, document OCR reading).
...
{\bf Software Engineer} \hfill Aug 2016 - Nov 2017 \\
  ...
  \begin{itemize}  \itemsep -2pt %reduce space between items
    ...
    \item {\bf Led telemetry project}. Took initiave to modernize legacy application with data.
    ...
    \item Ideas I came up with lead to a 50\% reducion in application crashes from prior year. 
  \end{itemize} 
...
{\bf Research Assistant } \hfill            Jan 2018 - Present \\
  ...
  \begin{itemize}  \itemsep -2pt %reduce space between items
    \item Building {\bf crystal structure classifier}. Identifies 11 classes with ~99\% accuracy (Keras/Tensorflow).
