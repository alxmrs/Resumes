...
Client & Android, RxJava, Angular.js, HTML5/CSS3, Bootstrap, Less, WebRTC, Socket.io, WPF \\
...
{\sl Research Assistant } \hfill            January 2018 - Present \\
                ...
                \item Convolution neural network correctly classifies crystal structures over 96\% of the time. 
                 \end{itemize} 
...
%
		...
		{\sl Research Assistant} \hfill            June 2013 - September 2015 \\
                Natural Computation Laboratory, UCSD Dept. of Cognitive Science, La Jolla, CA
                 ...
                 \item Build custom neural network layer for learned-norm pooling in EEG research application (Theano).
                 \item Created hands-on workshops to teach brain computer interface technology (OpenBCI, Python).
                 \item Developed BrainTag: a lasertag-based neurofeedback game for children with Autism (Arduino, C). 
