...
{\bf Machine Learning/Software Engineer } \hfill Nov 2017 - Present \\
  ...
  \begin{itemize}  \itemsep -2pt %reduce space between items
    ...
    \item Built {\bf core dialog engine}. Includes a STT/TTS system and conversation state management. Built features such as bluetooth pairing, calling an agent, and call rating purely through a voice interface. 
