...
\textbf{Languages} & Python, Java, Typescript, C++, JavaScript, C\#, Scala/F\#/OCaml \\
\textbf{Technologies} & Android, Vue.js, Spring Boot, Reactive Extensions,  SQL/No-SQL, AMQP, REST, AWS, GCP \\
