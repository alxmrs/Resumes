...
{\sl Machine Learning/Fullstack Engineer } \hfill            December 2017 - Present \\
                ...
                \item Developing chatbot-powered OCR reader in Android, complete with custom wake word detector, language engine, and document scanner (OpenCV, Tensorflow, Java 8, RxJava). 
		\item Developing a mobile-AI named Chloe for new product line. Building the core natural language processing engine  
                 \end{itemize} 
